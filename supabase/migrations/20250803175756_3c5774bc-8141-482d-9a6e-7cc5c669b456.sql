...
-- Security Fix 4: Add audit trigger for sensitive operations (check if exists first)
...
-- Create audit trigger for reservas table (already exists based on error, so skip)
